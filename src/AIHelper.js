...
function AI_helper_button() {
  ...
  const [messages, setMessages] = useImmer([]); //useimmer([])
  ...
  async function submitNewMessage() {
    ...
    setMessages(draft => [...draft, //setting up an array of old messages !! now using useState instead of us-immer, changing draft to prevMesagges
      ...
      try {
            ...
            console.log("Error Data:", err.response?.data?.detail);  // Log the specific error details
            setMessages(draft => {
                draft[draft.length - 1].loading = false;
  ...
  return (
    <div className="button-container">
      ...
      <button className="brutalist-button openai button-1" onClick={toggleChat}>
          ...
          <div className="chatbot-inner">
            <div className="chat-header">
              <div className="flex justify-between items-center">
                <h2 className="header-title">Chatbot Assistant</h2>
